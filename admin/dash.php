...
<body>
    ...
    <div class="sidebar">
        <a class="imagen" href="admin.php"><img src="../css/imagenes/Documento_sin_título-removebg-preview.png" alt="Acomite" width="120px"></a>
        <ul class="iconos">
            ...
            <li class="no-esp"><a class="ico" href="admin.php"><span class="fas fa-home"></span><label class="label">Menú</label></a>
            </li>
            <li class="no-esp"><a class="ico" href="ver_usuario.php"><span class="fas fa-clipboard-list"></span><label class="label">Usuarios</label></a>
            </li>
            <li class="no-esp"><a class="ico" href="bandeja_entrada.php"><span class="fa-solid fa-envelopes-bulk"></span><label class="citar">Correo</label></a>
            </li>
