...
agregarTexto($pdf, ucwords(utf8_decode($alumno['nombre'] . " " . $alumno['apellidos'])), 60, 70, "L", "Helvetica", 20, 0, 84, 115);
agregarTexto($pdf, $alumno['nombre_curso'], -250, 155, "C", "Helvetica", 11, 0, 84, 115);
agregarTexto($pdf, date("d/m/Y"), -350, 115, "C", "Helvetica", 30, 0, 84, 115);
$pdf->Output();
