...
<head>
    ...
    <style>
        ...
        .casilla {
            ...
            align-items: center;
            width: 100%;
            background-color: rgba(5, 7, 7, 0.48);
            padding: 4px;
            border-radius: 5px;
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="iconos">
            ...
            <li class="no-esp"><a class="ico" href="vista_alumnos.php"><span class="fas fa-user-graduate"></span><label class="label">Aprendiz</label></a>
            </li>
            <li class="no-esp"><a class="ico" href="vista_cursos.php"><span class="fa-solid fa-file-signature"></span><label class="citar">Citaciones</label></a>
            </li>
